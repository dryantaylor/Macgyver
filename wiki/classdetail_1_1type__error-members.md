...
<a href="classdetail_1_1type__error.html"
class="el">detail::type_error</a>, including all inherited members.

|                                                                                                                                           |                                                                          |                                                                                                           |
|-------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------|
| **create**(int id\_, const std::string &what_arg, BasicJsonContext context) (defined in <a href="classdetail_1_1type__error.html"         
 class="el">detail::type_error</a>)                                                                                                         | <a href="classdetail_1_1type__error.html"                                
                                                                                                                                             class="el">detail::type_error</a>                                         | <span class="mlabel">inline</span><span class="mlabel">static</span>                                      |
